...
namespace TGC.Tools.UserControls
{
    ...
    /// </summary>
    public partial class SceneEditorModifier : UserControl
    {
        ...
        /// </summary>
        private TGCVector3 getInitialPos()
        {
            ...
            return new TGCVector3(float.Parse(createPosX.Text), float.Parse(createPosY.Text), float.Parse(createPosZ.Text));
        }
        ...
        /// </summary>
        private TGCVector3 getTerrainCenter()
        {
            ...
            return new TGCVector3(float.Parse(terrainCenterX.Text), float.Parse(terrainCenterY.Text),
