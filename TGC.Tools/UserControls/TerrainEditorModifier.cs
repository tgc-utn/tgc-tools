...
{
    public partial class TerrainEditorModifier : UserControl
    {
        ...
        public TerrainEditorModifier(TgcTerrainEditor terrainEditor)
        {
        ...
        private void openFileVegetation_FileOk(object sender, CancelEventArgs e)
        {
            if (terrainEditor.HasVegetation)
                if (
                    MessageBox.Show("¿Remover vegetacion actual?", "El terreno ya tiene vegetacion", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    terrainEditor.clearVegetation();
                else
                    MessageBox.Show("Por ahora no se pueden importar modelos con nombres iguales a los ya cargados, de darse ese caso, las instancias viejas se eliminaran.",
        ...
        private void saveFileDialog1_FileOk(object sender, CancelEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                MessageBox.Show(this,
                    ...
                    + "Error: " + ex.Message + " - " + ex.InnerException.Message, "Export Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
