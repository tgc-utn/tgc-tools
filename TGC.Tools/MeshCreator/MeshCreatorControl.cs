...
namespace Examples.MeshCreator
{
    ...
    public partial class MeshCreatorControl : UserControl
    {
        ...
        private TgcTextureBrowser textureBrowser;
        private TgcTextureBrowser textureBrowserEPoly;
        private string defaultTexturePath;
        private string defaultMeshPath;
        private TgcMeshBrowser meshBrowser;
        private SaveFileDialog exportSceneSaveDialog;
        private TgcText2d objectPositionText;
        private ObjectBrowser objectBrowser;
        private bool fpsCameraEnabled;
        private Vector3 rotationPivot;
        private string lastSavePath;

        private List<EditorPrimitive> meshes;
        ...
        private List<EditorPrimitive> selectionList;
        ...
        private MeshCreatorCamera camera;
        ...
        private EditorPrimitive creatingPrimitive;
        ...
        private EditorGizmo currentGizmo;
        ...
        private float snapToGridCellSize;
        ...
        {
            //Abrir PDF
            System.Diagnostics.Process.Start(Environment.CurrentDirectory + "\\MeshCreator\\Guia MeshCreator.pdf");
        }
